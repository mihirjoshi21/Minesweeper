...
public class ShowcaseView extends RelativeLayout
    ...
    private void init() {
        ...
        if (mEndButton.getParent() == null) {
            ...
            int bottomMargin = (int) getResources().getDimension(R.dimen.button_margin_bottom);
            RelativeLayout.LayoutParams lps = (LayoutParams) generateDefaultLayoutParams();
            lps.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
            lps.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
            lps.setMargins(margin, margin, margin, bottomMargin);
            mEndButton.setLayoutParams(lps);
            ViewCompat.setBackgroundTintList(mEndButton,
                    ContextCompat.getColorStateList(getContext(),R.color.orange));
